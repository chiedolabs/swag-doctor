...
var SideNav = _wrapComponent('SideNav')((_temp = _class = (function (_Component) {
  ...
  _createClass(SideNav, [{
    ...
    value: function render() {
      ...
      var sidenavOutput = _.map(paths, function (path) {
        var subnavOutput = _.map(path.actions, function (action) {
        ...
        return _react3.default.createElement(
          _reactBootstrap.Nav,
          { stacked: true, key: path.route },
          _react3.default.createElement(
            _reactBootstrap.NavItem,
            { href: '#' + (0, _functions.generateID)(path.route), className: 'nav-header' },
            path.route
          ),
          subnavOutput
        );
